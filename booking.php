...
<body>
                ...
                <div class="reservation-form">
                    ...
                    <form id="form" action="booking_submit.php" method="POST">
                        <div class="form-group">
                            ...
                            <select id="purpose" class="searchInput" name="purpose" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="date" class="searchInput" name="date" required>
                        </div>
                        <div class="form-group">
                            <label for="time_slot">Time Slot:</label>
                            <select id="time_slot" class="searchInput" name="time_slot" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email" class="searchInput" name="email" required>
                        </div>
                        <div class="form-group">
                            <label for="contact">Contact Number:</label>
                            <input type="text" id="contact" class="searchInput" name="contact" required>
                        </div>
                        <div class="form-group">
                            <label for="name">Name:</label>
                            <input type="text" id="name" class="SanitizeInputField searchInput" name="name" required>
                        </div>
    ...
    <script src="(js)calendar_filler.js"></script>
    ...
    <script src="(js)monitoring_booking.js"></script>
</body>
</html>